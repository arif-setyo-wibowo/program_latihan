                ...
                <table id="example1" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="{{ route('cabor.edit',$item->id)}}" class="btn btn-info btn-sm">
                              <span class="mdi mdi-pencil-outline"></span>
                                Edit
                            </a>
                            <form action="{{ route('cabor.destroy',$item->id)}}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                ...
                <form action="{{ route('cabor.store')}}" method="POST">
                  @csrf
                    <div class="form-floating form-floating-outline mb-4">
                        <input type="text" class="form-control" id="basic-default-fullname" name="olahraga" placeholder="Olahraga" required/>
